...
contract MultiSigWallet
{
    ...
    ///
    /// Create a transaction. Since it is defined as a struct,
    ...
    function signTransaction(uint _transactionID)
    validOwner public
    {
      // Uses Transaction Structure. Above in TransferTo function, because
